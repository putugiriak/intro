...
gather(table4a, key = "year", value = "case", -country, convert=TRUE)
...
gather(table4b, key = "year", value = "case", -country, convert=TRUE)
...
(tb4 <- summarise(tb3, cases = sum(case, na.rm = TRUE))) ##na.rm mengabaikan nilai NA
